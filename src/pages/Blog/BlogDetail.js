  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex items-center justify-between flex-wrap mt-16 mb-4">
        <span>
          Author : <strong className="text-primary">Mohammad Ali</strong>
        </span>
        <span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-2 lg:col-span-1 bg-[#313131] px-4 py-6 rounded shadow-lg">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <TwitterShareButton url={url} title="Redux Blog by Mohammad Ali - ">
              <TwitterIcon size={32} round={true} />
            </TwitterShareButton>
            <LinkedinShareButton url={url} title="Redux Blog by Mohammad Ali -">
              <LinkedinIcon size={32} round={true} />
            </LinkedinShareButton>
            <WhatsappShareButton url={url} title="Redux Blog by Mohammad Ali -">
